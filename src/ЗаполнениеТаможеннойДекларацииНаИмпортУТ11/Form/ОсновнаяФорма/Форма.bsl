...
Процедура ЗаполнитьПоФайлуXML(Команда)
	...
	Если НЕ ВыбФайл.Существует() Тогда 
		Предупреждение("Файл по выбранному пути не найден! Загрузка невозможна.");
		Возврат;
	КонецЕсли;	
...
Процедура ОповещениеПослеВыбораФайлаДляЧтения(ВыбранныеФайлы, ДопПараметры) Экспорт
	...
	Если ТипЗнч(ВыбранныеФайлы) = Тип("Массив")	Тогда
		...
		Иначе
			Предупреждение("Файл по выбранному пути не найден!");
		КонецЕсли;	
	КонецЕсли;
...
Процедура ОповещениеПомещениеФайла(ПомещенныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(ПомещенныеФайлы) = Тип("Массив") Тогда
		...
		ПутьКФайлуНаСервере = ПомещенныеФайлы[0].Хранение;
	Иначе
	...
	ПараметрыКоманды.ПутьКФайлуНаСервере 	= ПутьКФайлуНаСервере;     
